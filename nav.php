...
<div class="container">
  <a class="navbar-brand" href="home.php">
    <img src="img/cookie.png" style="width:40px;">
    <b>Cookie</b> <sub><small class="text-danger font-weight-bold">Social</small></sub></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link text-dark"><input type="" placeholder="Search Here" class="mr-1 search_input" style="display: none; width: 300px;border:none;outline: none;border-bottom: 1px solid #aaa;"><i class="fas fa-search search_btn"></i></a>
      </li>
