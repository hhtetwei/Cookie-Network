...
<ul class="list-group">
	...
	$query=mysqli_query($conn,"SELECT * FROM user WHERE id!='".$_SESSION['id']."' LIMIT $start,$limit");
	while($friend_list=mysqli_fetch_assoc($query)){
	?>
  <li class="list-group-item">
  	...
  	<button class="mbtn btn btn-outline-dark btn-sm" data-toggle="modal" data-target="#mail_Modal" value="<?php echo $friend_list['email']; ?>"><i class="fas fa-envelope-open-text"></i> Mail</button>
  	</div>
  </li>
	<?php } ?>
